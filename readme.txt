...
- Options to style the lightbox (background, color, corner radius, etc ...) to fit it to your website design
- Show counter of medias
- Show a caption with title and description from the title attribute of the link
- Option to loop through the medias (go back to the first media after the last one)
</p>
